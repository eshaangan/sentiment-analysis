#!/usr/bin/env python3
"""Evaluate CNN model for sentiment analysis."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate CNN sentiment analysis model")
    ...
    # Load CNN model with correct configuration
    ...
    results_path = output_dir / "cnn_evaluation_results.yaml"
