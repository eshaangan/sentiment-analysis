#!/usr/bin/env python3
"""Evaluate pre-trained Transformer model for sentiment analysis."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate pre-trained Transformer sentiment analysis model")
    ...
    vocabulary = create_vocabulary_from_data(
        ...
        min_frequency=3,  # Match training settings
    ...
    # Load pre-trained Transformer model with correct configuration
    ...
    results = {
        ...
        "model_type": "Transformer_Pretrained",
        "model_parameters": model.count_parameters(),
    }

    results_path = output_dir / "transformer_pretrained_evaluation_results.yaml"
