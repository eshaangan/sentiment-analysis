#!/usr/bin/env python3
"""Train improved Transformer model for sentiment analysis."""
...
def main():
    """Main training function for improved Transformer model."""
    parser = argparse.ArgumentParser(description="Train improved Transformer model for sentiment analysis")
    ...
    parser.add_argument("--max-vocab-size", type=int, default=15000, help="Maximum vocabulary size")
    ...
    # Create vocabulary with larger size
    ...
    # Create improved Transformer model
    logger.info("Creating improved Transformer model...")
    ...
    # Set up training components with improved settings
    ...
    # Train the model
    logger.info("Starting improved Transformer training...")
    history = trainer.fit(
        epochs=args.epochs,
    ...
    # Save final model
    checkpoint_path = checkpoint_dir / "transformer_improved.pt"
    ...
    history_path = checkpoint_dir / "transformer_improved_history.yaml"
