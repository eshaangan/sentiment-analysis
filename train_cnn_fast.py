#!/usr/bin/env python3
"""Train CNN model for sentiment analysis with optimized settings."""
...
def main():
    """Main training function for optimized CNN model."""
    parser = argparse.ArgumentParser(description="Train optimized CNN model for sentiment analysis")
    ...
    parser.add_argument("--max-vocab-size", type=int, default=8000, help="Maximum vocabulary size")
    ...
    # Create CNN model with optimized settings
    ...
    # Save final model
    checkpoint_path = checkpoint_dir / "cnn_optimized.pt"
    ...
    history_path = checkpoint_dir / "cnn_optimized_history.yaml"
