#!/usr/bin/env python3
"""Evaluate augmented Transformer model for sentiment analysis."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate augmented Transformer sentiment analysis model")
    ...
    # Use the same vocabulary settings as training (with augmented data)
    vocabulary = create_vocabulary_from_data(
        "data/processed/imdb_train_augmented.csv",  # Use augmented data
        str(test_path),
        text_column="review",
        max_vocab_size=args.max_vocab_size,
        min_frequency=2,  # Match training settings
    ...
    # Load augmented Transformer model with correct configuration
    logger.info("Loading augmented Transformer model...")
    ...
    results = {
        ...
        "model_type": "Transformer_Augmented",
        "model_parameters": model.count_parameters(),
    }

    results_path = output_dir / "transformer_augmented_evaluation_results.yaml"
